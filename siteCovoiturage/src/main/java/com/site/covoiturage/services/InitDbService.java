	...
	public void init() {
		if (userRepository.findAll().size() == 0) {
			...
			if (annonceRepository.findAll().size() == 0) {
				...
				Annonce annonce = new Annonce("Paris", "Lyon", 3L, 3L, true,
						new SimpleDateFormat("dd/MM/yyyy").format(new Date()),
						new SimpleDateFormat("HH:mm").format(new Date()), 25, "Allee simple", "Mercedes", "N'importe ou",
						"N'importe ou", "Je pars sur Lyon visiter des parents j'ai trois places de libre dans ma voiture",
						true, true, null, false, 3, 1, 3, false, new SimpleDateFormat("dd/MM/yyyy").format(new Date()),
						"Classe c", user);
				...
				Annonce annonce1 = new Annonce("Rennes", "Bordeaux", 3L, 3L, true,
						...
						new SimpleDateFormat("HH:mm").format(new Date()), 25, "Allee simple", "Mercedes", "N'importe ou",
						"N'importe ou",
						"Je pars sur Bordeaux visiter des parents j'ai trois places de libre dans ma voiture", true, true,
						null, false, 4, 1, 4, false, new SimpleDateFormat("dd/MM/yyyy").format(new Date()), "Classe c", user);
