			...
			<div class="row">
				...
				<div>
					<br> <label class="col-sm-2"><spring:message
						...
						class="col-sm-5"><input class="form-control" id="pass"
						name="password" type="password" value="" /></span> <span
					...
					<br> <label class="col-sm-2"><spring:message
						...
						class="alert alert-danger" style="display: none"><spring:message
							code="PasswordMatches.user"></spring:message></span> <br>
					<br>
