		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="panel-heading modal-title" id="myModalLabel"
					style="color: #800000; font-weight: bold;" align="center">Connectez-vous</h3>
			</div>
			<div class="modal-body">
				...
				<form class="form-signin"
					...
					<button class="btn btn-lg btn-primary btn-block" type="submit">Se
						connecter</button>
						<br>
					<label >Pas encore inscrit? <a style="color:blue;"
						href="<spring:url value="/annonces/inscription.html"></spring:url>">Cliquez
							ici</a>
					</label>
				</form>
			</div>
