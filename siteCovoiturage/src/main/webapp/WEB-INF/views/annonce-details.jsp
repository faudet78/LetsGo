	...
	<div class="row">
		<div class="col-sm-12">
			<div class="col-sm-4 ">
				...
				<div class="panel-heading"><h4 style="color: #B22222;">Avec qui voyagez vous ?</h4></div>
				<div class="panel-body">
					<table class="table">
					
						<tr>
							<td><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user-1.png"></td>
							<td><c:choose>
									<c:when test="${annonce.user.sex }">
						...
						<c:choose>
							<c:when test="${annonce.placeDisponible=='3' }">
								<tr>
									<td><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"></td>
										<td>Il reste ${annonce.placeDisponible} places de libre.</td>
							</c:when>
							<c:when test="${annonce.placeDisponible=='2' }">
								<tr>
									<td><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"></td>
										<td>Il reste ${annonce.placeDisponible} places de libre.</td>
							</c:when>
							<c:when test="${annonce.placeDisponible=='1' }">
								<tr>
									<td ><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"></td>
										<td>Il reste ${annonce.placeDisponible} place de libre.</td>
							</c:when>
							<c:otherwise>
							<tr>
							<td></td>
							<td>Aucune place disponible, toutes les places sont prises.</td>
				...
				<div class="panel panel-default">
				<div class="panel-heading"><h4 style="color: #B22222;">Véhicule</h4></div>
				<div class="panel-body">
				<c:choose>
				<c:when test="${empty annonce.photo }">
					<img alt="vehicule" style="margin-right: 10px; margin-bottom: 10px;" class="img-rounded push-left" src="<%=request.getContextPath(  ) %>/resources/images/vehicule.jpg" width="140" height="140">
				</c:when>
				<c:otherwise>okk</c:otherwise>
				</c:choose>
				<h5 class="text-uppercase"><strong>${annonce.vehicule }</strong></h5><hr>
				<c:choose><c:when test="${!empty annonce.nbrePortes }">
				<h5>Nombre de portes : <strong>${annonce.nbrePortes  }</strong></h5>
				
				</c:when>
				
				
				</c:choose>
					<c:choose><c:when test="${annonce.climatisation==true }">
				<h5>Climatisation : <strong>Oui</strong>  </h5>
				
				</c:when>
				<c:otherwise>Climatisation : <strong>Non</strong></c:otherwise>
				
				
				</c:choose>
					<c:choose><c:when test="${annonce.hasMusic==true }">
				<h5>Musique : <strong>Oui</strong> </h5>
				
				</c:when>
				<c:otherwise>Musique : <strong>Non</strong></c:otherwise>
					...
					<div>
						<table class="table">
							...
							<tr>
								...
								<td><h5>
										<strong> ${annonce.heureDepart }h${annonce.minDepart }</strong>
										<small>(depart +/-15 minutes)</small>
									</h5></td>


							</tr>
							<tr>
								<td><i><img width="25"  height="25" alt="search" src="<%=request.getContextPath(  ) %>/resources/images/map-marker-green.png"></i></td>
								<td><h5>${annonce.lieuDepart }h${annonce.minDepart }</h5></td>
								<td><i><img width="25"  height="25" alt="search" src="<%=request.getContextPath(  ) %>/resources/images/map-marker-red.png"></i></td>
						...
						<table class="table">
							<tr>
								...
								<c:if test="${annonce.typeTrajet=='Allee simple' }">
									...
									<td><img alt=""
										src="<%=request.getContextPath()%>/resources/images/trajet-aller.png">
									</td>
								...
								<c:if test="${annonce.typeTrajet=='Allee retour' }">
									...
									<td><img alt=""
										src="<%=request.getContextPath()%>/resources/images/aller-retour.png">
									</td>
					...
					<table class="table">
						<tr>
							...
							<td><c:if test="${annonce.placeDisponible=='0' }">
									...
									<img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user-1.png">
									<img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png">
								...
								<img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user-1.png">
									<img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png"><img alt="Conducteur" width="20" height="20" src="<%=request.getContextPath(  ) %>/resources/images/user1.png">
					...
					<div class="panel-body">
						<div class="user">
							...
							<div class="push-right">
								<a data-toggle="modal" data-target="#profil">Voir le profil complet</a>
							</div>
							<div>
							
							<div class="modal fade" role="dialog" aria-labelledby="profilModal" id="profil">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"  style="color:#B22222; ">Informations sur le conducteur</h4>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
          ...
          <img class="img-circle push-left " 
           ...
           <h4>${annonce.user.firstName } ${annonce.user.lastName }</h4>
           <p>Date d'incription : <strong>${annonce.user.dateInscription }</strong></p> 
            </div>
          ...
          <div class="row">
          <div class="panel ">
          <div class="panel-heading"><h4 style="color: #B22222;">Activités</h4></div>
          <div class="panel-body">
          ...
          <div class="row">
          <div class="panel ">
          <div class="panel-heading"><h4 style="color: #B22222;">Autres trajets proposés</h4></div>
          <div class="panel-body">
          <h5><strong>Les 10 premiers trajets sur ${ nbreAnnonces}</strong></h5>
          <br>
          
          <table class="table">
          <c:forEach items="${annonces}" var="annonce">
          <tr>
          <td>${annonce.adresseDepart } - ${annonce.adresseArrivee }</td>
          <td>${annonce.prix } €</td>
