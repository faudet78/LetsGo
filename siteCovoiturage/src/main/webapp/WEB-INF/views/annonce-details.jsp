		...
		<div class="col-sm-12">
			<div class="col-sm-4 ">
				...
				<div class="panel panel-default ">
					<div class="panel-heading"><h4 style="color: #B22222;">Avec
							qui voyagez vous ?</h4></div>
			...
			<div class="panel-default col-sm-3 ">
				...
				<div class="panel-default panel">
					...
					<div class="panel-body">
						<div class="user"><img class="img-circle push-left "
							style="margin-right: 10px;"
							src="https://d1ovtcjitiy70m.cloudfront.net/vi-1/images/avatar/driver-male-72.png"
							width="50" height="50"
						>
							<div style="margin-bottom: 10px;">
								<h2 class="username">${annonce.user.firstName }</h2> <c:choose>
							...
							<div class="push-right"><a data-toggle="modal"
								data-target="#profil"
							>Voir le profil complet</a></div>
							<div>
												...
												<br>
													...
													<div class="row">
														<div class="panel ">
															<div class="panel-heading"><h4
																	style="color: #B22222;"
																>Autres trajets proposés</h4></div>
															<div class="panel-body">
																<h5>
