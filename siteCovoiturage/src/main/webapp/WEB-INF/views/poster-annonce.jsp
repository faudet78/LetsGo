...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/jquery.placepicker.js"
></script>
<div class="">
...
>
	...
	<div class="panel-body"><form:form id="annonceForm"
			modelAttribute="annonce" cssClass="form-horizontal registrationForm"
		>
			...
			<h3>DEPART / ARRIVEE, DATES</h3>
			<fieldset>
				<legend>
					<i>Où et quand partez vous?</i>
				</legend>
				<h5>
				...
				>
					<div class="form-group"><label for="adresseDepart"
						class="control-label col-sm-3 col-sm-offset-2  "
					>Ville de départ <strong style="color: red">* </strong>
					</label>
						<div class="col-sm-3 has-feedback"><form:input
								path="adresseDepart" cssClass="form-control placepicker"
								placeholder="Exemple: Lyon" data-toggle="tooltip"
								data-placement="right"
								title="Entrer une ville de
							départ, pour donner des indications à vos passagers"
							...
							></i> <form:errors path="adresseDepart"></form:errors></div></div>
					<div class="form-group "><label for="lieuDepart"
						class="control-label col-sm-3 col-sm-offset-2"
					>Lieu de rendez-vous</label>
						<div class="col-sm-3"><form:input path="lieuDepart"
								cssClass="form-control" placeholder="Lieu de départ"
							/> <form:errors path="lieuDepart"></form:errors></div></div>
				</div>
				<h5>
				...
				>
					<div class="form-group has-feedback"><label
						for="adresseArrivee"
						class="control-label col-sm-3 col-sm-offset-2 "
					>Ville d'arrivée <strong style="color: red">* </strong>
					</label>
						<div class="col-sm-3"><form:input path="adresseArrivee"
								cssClass="form-control placepicker" placeholder="Exemple: Paris"
								data-toggle="tooltip" data-placement="right"
								title="Entrer une ville de
							d'arrivée, pour donner des indications à vos passagers"
							/> <i class="form-control-feedback "><img width="20"
								style="margin-top: 7px;" height="20" alt="search"
								src="<%=request.getContextPath()%>/resources/images/map-marker-red.png"
							></i> <form:errors path="adresseArrivee"></form:errors></div></div>
					<div class="form-group "><label for="lieuDArrivee"
						class="control-label col-sm-3 col-sm-offset-2 "
					>Lieu d'arrivée</label>
						<div class="col-sm-3"><form:input path="lieuDepart"
								cssClass="form-control" placeholder="Lieu d'arrivée"
							/> <form:errors path="lieuDepart"></form:errors></div></div>
				</div>
				<h5>
				...
				>
					<div class="row ">
						<div class="col-sm-2 col-sm-offset-3">
							<div
							class="form-group date input-group input-append date field  "
							id="dateRangePicker"
						><input type="text" class="form-control" name="jourDepart"
								value="${jourDepart }" placeholder="JJ/MM/AAAA"
							/> <span class="input-group-addon add-on"><span
									class="glyphicon glyphicon-calendar "
								></span></span></div>
					</div>
						<div class="col-sm-2">
							<div class="form-group "><form:select path="heureDepart"
								...
								</form:select> <form:errors path="heureDepart"></form:errors></div>
					</div>
						<div class="col-sm-2">
							<div class="form-group "><form:select path="minDepart"
									cssClass="form-control"
								>
			...
			<h3>PLACES, PRIX, CONTACT</h3>
			<fieldset>
				<legend>
					<i>Places,Prix,contact</i>
				</legend>
				<h5>
				...
				<div class="thumbnail"
					style="background-color: #F5F5F5; padding-top: 15px;"
				>
					<div class="form-group"><label for="nbrePersonnes"
						class="control-label col-sm-3 col-sm-offset-2"
					>A combien partez-vous?<strong style="color: red">* </strong>
					</label>
						<div class="col-sm-2"><form:select path="nbrePersonnes"
								cssClass="form-control"
							>
							...
							</form:select> <form:errors path="nbrePersonnes"></form:errors></div></div>
					<div class="form-group"><label for="placeProposees"
						class="control-label col-sm-3 col-sm-offset-2"
					>Combien de places proposez-vous<strong style="color: red">
								*</strong>
					</label>
						<div class="col-sm-2"><form:select path="placeProposees"
								cssClass="form-control"
							>
								<form:option value="1">1</form:option>
								<form:option value="2">2</form:option>
							...
							</form:select> <form:errors path="placeProposees"></form:errors></div></div>
					<div class="form-group"><label for="nbreSacs"
						class="control-label col-sm-3 col-sm-offset-2"
					>Nombre de valises / sacs de voyage acceptés au total ? </label>
						<div class="col-sm-2"><form:select path="nbreSacs"
								cssClass="form-control"
							>
								<form:option value="1">1</form:option>
								<form:option value="2">2</form:option>
								...
								<form:option value="6">6</form:option>
								<form:option value="7">7</form:option>
							</form:select> <form:errors path="nbreSacs"></form:errors></div></div>
				</div>
				<h5>
				...
				>
					<div class="form-group"><label for="prix"
						class="control-label col-sm-3 col-sm-offset-2 "
					>Prix demandé ( € )<strong style="color: red"> *</strong>
					</label>
						<div class="col-sm-2 "><form:input path="prix"
								cssClass="form-control" value="25"
							/> <form:errors path="prix"></form:errors></div></div>
				</div>
				<h5>
				...
				>
					<div class="form-group"><label for="prix"
						class="control-label col-sm-3 col-sm-offset-2 "
					>Veuillez ajouter plus de détails sur votre trajet. Cela vous
							évitera beaucoup de questions de vos passagers. </label>
						<div class="col-sm-4 "><form:textarea path="details"
								cssClass="form-control" cols="50" data-toggle="tooltip"
								data-placement="right"
								...
								rows="4"
							/> <form:errors path="details"></form:errors></div></div>
				</div>
			</fieldset>
			<h3>VALIDATION</h3>
			<fieldset>
