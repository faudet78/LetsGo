		...
		>
				<h4 align="center">
					<span><img width="40" height="40" alt="search"
						src="<%=request.getContextPath()%>/resources/images/Search-1.png"
					></span> <strong class="text-uppercase" style="color: white;">Rechercher
		...
		>
			...
			>
					<div class="form-group has-feedback field"><input type="text"
						class="form-control" placeholder="Adresse de départ"
						value="${adresseD }" id="adresseD" name="adresseD"
				...
				></span>
					<div class="form-group has-feedback field"><input type="text"
						class="form-control" id="adresseA" placeholder="Adresse d'arrivée"
					...
					<ul class="pagination">
						<li><c:if test="${current=='0' }">
								...
								<a class="btn btn-default" aria-label="Previous"
									href='<spring:url value="/annonces.html?page=${current - 1 }"></spring:url>'
...
s.html?page=${current + 1 }"></spring:url>'
			...
			<ul class="trip-search-results">
				<c:choose>
					<c:when test="${!empty annonces }">
						...
						<div class="" style="text-align: center;"><c:if
								test="${maxPages>'0' }"
							>
	page : ${current+1 }/${maxPages }
