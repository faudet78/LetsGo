			...
			<div class="panel-heading panel-default text-capitalize"
				...
				<h4 align="center">
					<span class="glyphicon glyphicon-search"></span> <strong
						class="text-uppercase" style="color: white;">Rechercher
...
s/chercherAnnonce "></spring:url>' class="form-inline">



					<div class="form-group has-feedback field">
						<input type="text" class="form-control"
							placeholder="Adresse de depart" value="${adresseD }"
							name="adresseD" /> <i
							class="form-control-feedback "><img width="20" style="margin-top: 7px;" height="20" alt="search" src="<%=request.getContextPath(  ) %>/resources/images/map-marker-green.png"></i>
					</div>
					<span style="margin-left: 5px; margin-right: 5px;"
						class="glyphicon glyphicon-arrow-right"></span>
					<div class="form-group has-feedback field">
						<input type="text" class="form-control"
							placeholder="Adresse d'arrivee" value="${adresseA }"
							name="adresseA" /> <i
							class="form-control-feedback "><img width="20" style="margin-top: 7px;" height="20" alt="search" src="<%=request.getContextPath(  ) %>/resources/images/map-marker-red.png"></i>
					</div>
						...
						<ul class="pagination">
							<li><c:if test="${current=='0' }">
									...
									<a class="btn btn-default" aria-label="Previous"
										href='<spring:url value="/annonces/chercherAnnonce?adresseD=${adresseD }&adresseA=${adresseA }&page=${current - 1 }"></spring:url>'><span
										aria-hidden="true">&laquo;</span></a>
								</c:if></li>
